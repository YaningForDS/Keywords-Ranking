...
class text_analysis():
	def __init__(self):
		self.csvfile1 = codecs.open('Bi_sheet1.csv','w',encoding = 'utf-8')
		self.csvfile2 = codecs.open('Bi_sheet2.csv','w',encoding = 'utf-8')
	...
	def main(self):
		...
		vect = CountVectorizer(min_df = 10, ngram_range=(2, 2),stop_words = 'english',decode_error='ignore',tokenizer = self.tokenize)
